...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    with open(opt.data) as f:
        data_dict = yaml.load(f, Loader=yaml.SafeLoader)  # data_before dict
...
if __name__ == '__main__':
    ...
    parser.add_argument('--single-cls', action='store_true', help='train multi-class data_before as single-class')
